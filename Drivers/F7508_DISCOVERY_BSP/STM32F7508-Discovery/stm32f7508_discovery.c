...
/** @defgroup STM32F7508_DISCOVERY_LOW_LEVEL_Private_Defines STM32F7508_DISCOVERY_LOW_LEVEL Private Defines
  ...
  */
/**
 * @brief STM32F7508 DISCOVERY BSP Driver version number V1.0.1
   */
#define __STM32F7508_DISCO_BSP_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __STM32F7508_DISCO_BSP_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __STM32F7508_DISCO_BSP_VERSION_SUB2   (0x01) /*!< [15:8]  sub2 version */
...
/**
  ...
  * @oaram  Size: Data size
  * @retval None
  */
void CAMERA_IO_Write_Multiple(uint8_t Addr, uint8_t Reg, uint8_t* Data, uint16_t Size)
{
  I2Cx_WriteMultiple(&hI2cExtHandler, Addr, (uint16_t)Reg, I2C_MEMADD_SIZE_8BIT,Data,Size);
}
